...
<div class="col-lg-12">
	<div class="card card-outline card-primary">
		...
		<div class="form-group">
				...
				<div class="custom-file">
	              <input type="file" class="custom-file-input rounded-circle" id="customFile" name="slider"  multiple accept="image/*" onchange="displayImg4(this,$(this))">
	              <label class="custom-file-label" for="customFile">Choose file</label>
	            </div>
			</div>
			<div class="form-group d-flex justify-content-center">
				<img src="<?php echo validate_image($_settings->info('slider')) ?>" alt="" id="slider" class="img-fluid img-thumbnail">
			</div>
		</div>
